...
export default function Status({navigation}) {
  ...
  if (ocupado) {
    return (
      <View>
        <Text style={styles.tituloCorridas}>Corrida em andamento</Text>
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.viewCorrida}>
              ...
              <Button
                ...
                color="orange"
                onPress={() => {
                  finalizarCorrida(item.key),
                    parado(item.keyMotorista),
                    pegaDadosAndamento(),
                    pegaDados();
                }}
              />
  ...
  return (
    <ScrollView>
      ...
      <Text style={styles.tituloCorridas}>Corridas disponíveis</Text>
      <View>
        <FlatList
            ...
            <View style={styles.viewCorrida}>
              ...
              <View style={styles.viewButton}>
                <Button
                  title="Aceitar"
                  onPress={() => {
                    aceitarCorrida(item.key),
                      indisp(item.keyMotorista),
                      pegaDadosAndamento(),
                      pegaDados();
                  }}
                />
              ...
              <View style={styles.viewButton}>
                <Button
                  ...
                  color="red"
                  onPress={() => {
                    recusarCorrida(item.key), pegaDadosAndamento(), pegaDados();
                  }}
                />
              </View>
            </View>
